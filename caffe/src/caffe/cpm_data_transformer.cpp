...
void CPMDataTransformer<Dtype>::Transform_nv(const Datum& datum, Dtype* transformed_data, Dtype* transformed_label, int cnt) {
  ...
  // ******************************************** get the image from datum, and do transformation
  CPUTimer timer1;
  timer1.Start();
...
template<typename Dtype>
void CPMDataTransformer<Dtype>::setLabel(Mat& im, const std::string label, const Point& org) {
...
// *****************************************inherit from original data_transformer.cpp with minor changes*********************************************//
template<typename Dtype>
...
template<typename Dtype>
void CPMDataTransformer<Dtype>::Transform(const vector<Datum> & datum_vector, Blob<Dtype>* transformed_blob) {
...
template<typename Dtype>
void CPMDataTransformer<Dtype>::Transform(const vector<cv::Mat> & mat_vector, Blob<Dtype>* transformed_blob) {
...
template<typename Dtype>
void CPMDataTransformer<Dtype>::Transform(const cv::Mat& cv_img, Blob<Dtype>* transformed_blob) {
...
template<typename Dtype>
void CPMDataTransformer<Dtype>::Transform(Blob<Dtype>* input_blob, Blob<Dtype>* transformed_blob) {
...
template<typename Dtype>
vector<int> CPMDataTransformer<Dtype>::InferBlobShape(const vector<Datum> & datum_vector) {
...
template<typename Dtype>
vector<int> CPMDataTransformer<Dtype>::InferBlobShape(const vector<cv::Mat> & mat_vector) {
